...
import com.alkhalildevelopers.apps.quranepak.presenter.data.QuranDataPresenter;
...
import com.alkhalildevelopers.apps.quranepak.service.util.PermissionUtil;
...
import com.alkhalildevelopers.apps.quranepak.worker.WorkerConstants;
import java.io.File;
...
public class QuranDataActivity extends Activity implements
  ...
  private void checkPermissions() {
    ...
    boolean usesExternalFileDir = path != null && path.contains("com.alkhalildevelopers");
  ...
  /**
   * this method asks the service to download alkhalildevelopers images.
   *
