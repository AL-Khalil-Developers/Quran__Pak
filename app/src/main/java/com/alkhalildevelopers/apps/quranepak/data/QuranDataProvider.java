...
public class QuranDataProvider extends ContentProvider {
  ...
  public static final Uri SEARCH_URI = Uri.parse("content://" + AUTHORITY + "/alkhalildevelopers/search");

  public static final String VERSES_MIME_TYPE =
      ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.alkhalildevelopers.apps.quranepak";
  ...
  private static UriMatcher buildUriMatcher() {
    ...
    matcher.addURI(AUTHORITY, "alkhalildevelopers/search", SEARCH_VERSES);
    matcher.addURI(AUTHORITY, "alkhalildevelopers/search/*", SEARCH_VERSES);
