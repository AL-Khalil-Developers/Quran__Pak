...
import com.alkhalildevelopers.apps.quranepak.data.QuranFileConstants;
...
public class ArabicDatabaseUtils {
   ...
   * arabic database (alkhalildevelopers.ar.db) has the first verse from each sura as "[basmallah] ayah" - this
  ...
  public static String getAyahWithoutBasmallah(int sura, int ayah, String ayahText) {
    ...
    // that if we update alkhalildevelopers.ar.db one day to fix this issue and older clients get a new copy of
