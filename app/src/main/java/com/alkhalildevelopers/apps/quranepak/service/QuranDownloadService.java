...
import com.alkhalildevelopers.apps.quranepak.extension.CloseableExtensionKt;
import com.alkhalildevelopers.apps.quranepak.service.util.QuranDownloadNotifier;
import com.alkhalildevelopers.apps.quranepak.service.util.QuranDownloadNotifier.NotificationDetails;
import com.alkhalildevelopers.apps.quranepak.service.util.QuranDownloadNotifier.ProgressIntent;
...
import com.alkhalildevelopers.apps.quranepak.util.ZipUtils;
...
public class QuranDownloadService extends Service implements
  ...
  public static final String ACTION_DOWNLOAD_URL =
      "com.alkhalildevelopers.apps.quranepak.DOWNLOAD_URL";
  public static final String ACTION_CANCEL_DOWNLOADS =
      "com.alkhalildevelopers.apps.quranepak.CANCEL_DOWNLOADS";
  public static final String ACTION_RECONNECT =
      "com.alkhalildevelopers.apps.quranepak.RECONNECT";
  ...
  private boolean downloadFileWrapper(String urlString, String destination,
    ...
    for (int i = 0; i < RETRY_COUNT; i++) {
      ...
      if (i > 0) {
        ...
        if (urlString.contains("alkhalildevelopers.com") || urlString.contains("quranicaudio.com")) {
