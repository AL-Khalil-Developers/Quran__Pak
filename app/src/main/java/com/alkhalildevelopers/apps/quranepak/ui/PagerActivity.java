...
import com.alkhalildevelopers.apps.quranepak.HelpActivity;
...
import com.alkhalildevelopers.apps.quranepak.dao.audio.AudioRequest;
...
import com.alkhalildevelopers.apps.quranepak.model.bookmark.BookmarkModel;
import com.alkhalildevelopers.apps.quranepak.model.translation.ArabicDatabaseUtils;
import com.alkhalildevelopers.apps.quranepak.di.module.activity.PagerActivityModule;
import com.alkhalildevelopers.apps.quranepak.presenter.audio.AudioPresenter;
import com.alkhalildevelopers.apps.quranepak.presenter.bookmark.RecentPagePresenter;
...
import com.alkhalildevelopers.apps.quranepak.service.util.DefaultDownloadReceiver;
import com.alkhalildevelopers.apps.quranepak.service.util.QuranDownloadNotifier;
import com.alkhalildevelopers.apps.quranepak.service.util.ServiceIntentHelper;
import com.alkhalildevelopers.apps.quranepak.ui.fragment.AddTagDialog;
import com.alkhalildevelopers.apps.quranepak.ui.fragment.AyahActionFragment;
...
import com.alkhalildevelopers.apps.quranepak.ui.helpers.JumpDestination;
...
import com.alkhalildevelopers.apps.quranepak.ui.helpers.QuranPageAdapter;
import com.alkhalildevelopers.apps.quranepak.ui.helpers.SlidingPagerAdapter;
import com.alkhalildevelopers.apps.quranepak.ui.util.ToastCompat;
import com.alkhalildevelopers.apps.quranepak.ui.util.TranslationsSpinnerAdapter;
import com.alkhalildevelopers.apps.quranepak.util.AudioUtils;
import com.alkhalildevelopers.apps.quranepak.util.QuranAppUtils;
...
import com.alkhalildevelopers.apps.quranepak.widgets.AudioStatusBar;
import com.alkhalildevelopers.apps.quranepak.widgets.AyahToolBar;
import com.alkhalildevelopers.apps.quranepak.widgets.IconPageIndicator;
import com.alkhalildevelopers.apps.quranepak.widgets.QuranSpinner;
import com.alkhalildevelopers.apps.quranepak.widgets.SlidingUpPanelLayout;
...
import static com.alkhalildevelopers.apps.quranepak.ui.helpers.SlidingPagerAdapter.AUDIO_PAGE;
import static com.alkhalildevelopers.apps.quranepak.ui.helpers.SlidingPagerAdapter.PAGES;
import static com.alkhalildevelopers.apps.quranepak.ui.helpers.SlidingPagerAdapter.TAG_PAGE;
import static com.alkhalildevelopers.apps.quranepak.ui.helpers.SlidingPagerAdapter.TRANSLATION_PAGE;
import static com.alkhalildevelopers.apps.quranepak.widgets.AyahToolBar.AyahToolBarPosition;
    ...
    viewPager.addOnPageChangeListener(new OnPageChangeListener() {
      ...
      public void onPageScrolled(int position, float positionOffset,
        ...
        if (ayahToolBar.isShowing() && ayahToolBarPos != null) {
          ...
          if (position == barPos) {
            // Swiping to next ViewPager page (i.e. prev alkhalildevelopers page)
            ayahToolBarPos.xScroll = -positionOffsetPixels;
          } else if (position == barPos - 1) {
            // Swiping to prev ViewPager page (i.e. next alkhalildevelopers page)
